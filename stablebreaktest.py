...
!git clone https://github.com/nonnonstop/sd-webui-3d-open-pose-editor /content/stable-diffusion-webui/extensions/sd-webui-3d-open-pose-editor /content/stablebreaktest/extensions/sd-webui-3d-open-pose-editor
...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/ControlNet-v1-1/resolve/main/control_v11p_sd15_depth_fp16.safetensors -d /content/stablebreaktest/extensions/sd-webui-controlnet/models -o control_v11p_sd15_depth_fp16.safetensors
...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/ControlNet-v1-1/resolve/main/control_v11u_sd15_tile_fp16.safetensors -d /content/stablebreaktest/extensions/sd-webui-controlnet/models -o control_v11u_sd15_tile_fp16.safetensors
...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/ControlNet-v1-1/raw/main/control_v11p_sd15_depth_fp16.yaml -d /content/stablebreaktest/extensions/sd-webui-controlnet/models -o control_v11p_sd15_depth_fp16.yaml
...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/ControlNet-v1-1/raw/main/control_v11p_sd15_lineart_fp16.yaml -d /content/stablebreaktest/extensions/sd-webui-controlnet/models -o control_v11p_sd15_lineart_fp16.yaml
...
!aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/ControlNet-v1-1/raw/main/control_v11u_sd15_tile_fp16.yaml -d /content/stablebreaktest/extensions/sd-webui-controlnet/models -o control_v11u_sd15_tile_fp16.yaml
